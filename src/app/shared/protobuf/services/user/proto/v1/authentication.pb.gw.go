...
func RegisterAuthenticationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthenticationServiceServer) error {
	...
	mux.Handle("POST", pattern_AuthenticationService_SignUp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/services.user.proto.v1.AuthenticationService/SignUp", runtime.WithHTTPPathPattern("/services.user.proto.v1.AuthenticationService/SignUp"))
		if err != nil {
	...
	mux.Handle("POST", pattern_AuthenticationService_SignIn_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/services.user.proto.v1.AuthenticationService/SignIn", runtime.WithHTTPPathPattern("/services.user.proto.v1.AuthenticationService/SignIn"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AuthenticationService_LogOut_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/services.user.proto.v1.AuthenticationService/LogOut", runtime.WithHTTPPathPattern("/services.user.proto.v1.AuthenticationService/LogOut"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterAuthenticationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthenticationServiceClient) error {
	...
	mux.Handle("POST", pattern_AuthenticationService_SignUp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/services.user.proto.v1.AuthenticationService/SignUp", runtime.WithHTTPPathPattern("/services.user.proto.v1.AuthenticationService/SignUp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AuthenticationService_SignIn_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/services.user.proto.v1.AuthenticationService/SignIn", runtime.WithHTTPPathPattern("/services.user.proto.v1.AuthenticationService/SignIn"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AuthenticationService_LogOut_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/services.user.proto.v1.AuthenticationService/LogOut", runtime.WithHTTPPathPattern("/services.user.proto.v1.AuthenticationService/LogOut"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_AuthenticationService_SignUp_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"services.user.proto.v1.AuthenticationService", "SignUp"}, ""))

	pattern_AuthenticationService_SignIn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"services.user.proto.v1.AuthenticationService", "SignIn"}, ""))

	pattern_AuthenticationService_LogOut_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"services.user.proto.v1.AuthenticationService", "LogOut"}, ""))
)
